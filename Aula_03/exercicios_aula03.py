...
def ValidadorTemp():
    try:
        ...
        print('A temperatura não é válida. Tente novamente')
...
def ValidaçãoEntrada():
    try:
        idade = int(input('Qual é sua idade? '))
        email = str(input('Qual é seu e-mail? '))
        if idade >= 18 and idade <= 65 and '@' in email and '.com' in email:
            print('Dados de usuário válidos')
        else:
            print('Usuário não preenche os requisitos de sistema')
    except:
        print('Dados Inválidos. Por favor preencha corretamente')
        return ValidaçãoEntrada()
